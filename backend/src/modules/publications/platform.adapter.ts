...
import { FacebookPlatformAdapter } from "../integrations/facebook.adapter.js";
...
adapters.set("FACEBOOK", new FacebookPlatformAdapter());
adapters.set("INSTAGRAM", new InstagramPlatformAdapter());
